// resources/js/Pages/AsistenOfficer/Tasks/Index.jsx
...
const TasksIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentTask) {
            Inertia.put(`/Officer/Task/${currentTask.id}`, submitData);
        } else {
            Inertia.post('/Officer/Task', submitData);
        }
    };
    ...
    const handleDelete = (taskId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/Officer/Task/${taskId}`);
            }
        });
    };
