// resources/js/Pages/AsistenOfficer/CategoriesTask/Index.jsx
...
const CategoriesTaskIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentCategory) {
            Inertia.put(`/Officer/Category/Task/${currentCategory.id}`, formData);
        } else {
            Inertia.post('/Officer/Category/Task', formData);
        }
    };
    ...
    const handleDelete = (categoryId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/Officer/Category/Task/${categoryId}`);
            }
        });
    };
