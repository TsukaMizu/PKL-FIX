...
const ItemStockIndex = ({ stocks = [], categories, specifications = [] }) => {
    ...
    const handleSpecSubmit = (e) => {
        ...
        Inertia.post('/Officer/Itemstock', finalData, {
            onSuccess: () => {
    ...
    fetch(`/Officer/Itemstock/${stock.id}/items-without-sn`)
    ...
    const handleSerialNumberSubmit = () => {
        ...
        Inertia.post(`/Officer/Itemstock/${selectedStock.id}/serial-numbers`, {
