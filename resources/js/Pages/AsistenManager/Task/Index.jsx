// resources/js/Pages/AsistenManager/Tasks/Index.jsx
...
const TasksIndex = () => {
    const { tasks = [], employees = [], categories = [], currentDateTime , flash } = usePage().props;
    ...
    const handleSubmit = (e) => {
        ...
        if (currentTask) {
            Inertia.put(`/AsistenManager/Task/${currentTask.id}`, submitData);
        } else {
            Inertia.post('/AsistenManager/Task', submitData);
        }
    };
    ...
    const handleDelete = (taskId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/AsistenManager/Task/${taskId}`);
            }
        });
    };
