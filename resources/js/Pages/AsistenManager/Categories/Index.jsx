...
const CategoryIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentCategory) {
            ...
            Inertia.put(`/AsistenManager/Category/Item/${currentCategory.id}`, formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
            ...
            // Create new category
            Inertia.post('/AsistenManager/Category/Item', formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
    ...
    const handleDelete = (categoryId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/AsistenManager/Category/Item/${categoryId}`, {
                    onSuccess: () => {
