...
const StatusBadge = ({ status, small = false }) => {
    ...
    const TasksPanel = () => {
        // Definisikan categoryData dengan pengecekan data yang lebih baik
