// resources/js/Pages/AsistenManager/Employees/Index.jsx
...
const EmployeesIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentEmployee){
            Inertia.put(`/AsistenManager/Employee/${currentEmployee.id}`, formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
            ...
            Inertia.post('/AsistenManager/Employee', formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
    ...
    const handleDelete = (employeeId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/AsistenManager/Employee/${employeeId}`);
            }
        });
    };
