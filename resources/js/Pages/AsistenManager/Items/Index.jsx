...
export default function Index({ auth, items, employees, currentTime, currentUser }) {
    ...
    const handleBorrow = () => {
        ...
        axios.post(`/AsistenManager/Items/${selectedItem.id}/borrow`, formData)
            .then(response => {
...
const handleReturn = (item) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            axios.post(`/AsistenManager/Items/${item.id}/return`)
                .then(response => {
                    Swal.fire(
                        'Returned!',
    ...
    const handleUpdateStatus = () => {
        ...
        axios.put(`AsistenManager/Items/${selectedItem.id}/status`, statusForm)
            .then(response => {
    ...
    return (
        <AuthenticatedLayout role={"Asisten Manager"} user={auth.user} title="Asset Management">
