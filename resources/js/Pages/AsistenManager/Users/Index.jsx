...
const Users = ({ users = [], roles = [], auth }) => {
    ...
    const handleRoleSubmit = (e) => {
        ...
        if (currentUser) {
            ...
            Inertia.put(`/AsistenManager/Users/${currentUser.id}`, finalData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
            ...
            // Create new user
            Inertia.post('/AsistenManager/Users', finalData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
    ...
    const handleDelete = (userId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/AsistenManager/Users/${userId}`);
            }
        });
    };
    ...
    const handleSubmit = (e) => {
        ...
        if (currentUser) {
            // Update existing user
            Inertia.put(`/AsistenManager/Users/${currentUser.id}`, formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
            ...
            // Create new user
            Inertia.post('AsistenManager/Users', formData, {
                preserveScroll: true,
                onSuccess: (page) => {
