...
const CategoryIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentCategory) {
            ...
            Inertia.put(`/Manager/Category/Item/${currentCategory.id}`, formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
            ...
            // Create new category
            Inertia.post('/Manager/Category/Item', formData, {
                onSuccess: () => {
                    MySwal.fire({
                        icon: 'success',
                        title: 'Success',
    ...
    const handleDelete = (categoryId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/Manager/Category/Item/${categoryId}`, {
                    onSuccess: () => {
