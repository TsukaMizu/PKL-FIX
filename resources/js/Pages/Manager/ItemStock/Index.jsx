...
const ItemStockIndex = ({ stocks = [], categories, specifications = [] }) => {
    ...
    const handleSpecSubmit = (e) => {
        ...
        Inertia.post('/Manager/Itemstock', finalData, {
            onSuccess: () => {
    ...
    fetch(`/Manager/Itemstock/${stock.id}/items-without-sn`)
    ...
    const handleSerialNumberSubmit = () => {
        ...
        Inertia.post(`/Manager/Itemstock/${selectedStock.id}/serial-numbers`, {
