// resources/js/Pages/AsistenManager/CategoriesTask/Index.jsx
...
const CategoriesTaskIndex = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentCategory) {
            Inertia.put(`/Manager/Category/Task/${currentCategory.id}`, formData);
        } else {
            Inertia.post('/Manager/Category/Task', formData);
        }
    };
    ...
    const handleDelete = (categoryId) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/Manager/Category/Task/${categoryId}`);
            }
        });
    };
